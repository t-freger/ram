...
<h3 align="center">ram - 高性能的自托管照片和视频备份方案</h3>
<p align="center">  
请注意: 此 README 不是由 ram 团队维护, 而是依靠贡献者来更新的，这意味着它可能并不会被及时更新。感谢理解。
</p>
<br/>
<a href="https://ram.app">
<img src="../design/ram-screenshots.png" title="界面截图">
</a>
<br/>
...
- [官方文档](https://ram.app/docs)
- [路线图](https://github.com/orgs/ram-app/projects/1)
- [示例](#示例)
- [功能特性](#功能特性)
- [介绍](https://ram.app/docs/overview/introduction)
- [安装](https://ram.app/docs/install/requirements)
- [贡献指南](https://ram.app/docs/overview/support-the-project)

## 官方文档

您可以在 https://ram.app/ 找到官方文档（包含安装手册）。

## 示例

您可以在 https://demo.ram.app  访问示例。

在移动端, 您可以使用 `https://demo.ram.app/api` 获取 `服务终端链接`
