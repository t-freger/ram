...
>
  <div
    class="fixed top-0 z-10 flex h-16 w-full items-center justify-between border-b bg-white p-1 dark:border-ram-dark-gray dark:bg-black dark:text-ram-dark-fg md:p-8"
  >
  ...
  <div class="flex flex-wrap gap-1 bg-ram-bg p-2 pb-8 dark:bg-ram-dark-bg md:px-8 mt-16">
    <slot />
  </div>
</section>
