...
Hello everyone, it is my pleasure to deliver the new release of ram to you. The team has been working hard to bring you the new features and improvements. This release includes some big features that the community has been asking since the beginning of ram. We hope you will enjoy it.
...
LivePhoto on iOS is now supported in ram.
...
I want to borrow this chance to express my gratitude to [@EnricoBilla](https://github.com/EnricoBilla), who has been the trailblazer for this feature since the beginning days of ram. His PR has sparked ideas, suggestions, and discussion among the team member on how to integrate this feature successfully into the app. Thank you so much for your work and your time.

OAuth is now integrated into the system. Please follow the guide [here](https://ram.app/docs/usage/oauth) to set up your OAuth integration
...
OAUTH_ENABLED=true
OAUTH_ISSUER_URL=http://10.1.15.216:9000/application/o/ram-test/
...
For more details, please check out the [release note](https://github.com/ram-app/ram/releases/tag/v1.36.0_55-dev)
