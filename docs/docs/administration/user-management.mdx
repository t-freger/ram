...
ram supports multiple users, each with their own library.
...
If you need to remove a user from ram, head to "Administration", where users can be scheduled for deletion. The user account will immediately become disabled and their library and all associated data will be removed after 7 days by default.
