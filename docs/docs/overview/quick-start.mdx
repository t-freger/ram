...
Here is a quick, no-choices path to install ram and take it for a test drive.
...
You can select the Jobs tab to see ram processing your photos.

<img src={require('/docs/guides/img/jobs-tab.png').default} title="Jobs tab" />

## Set up your backups

You may want to back up the content of your ram instance
...
You can use [ram-go](https://github.com/simulot/ram-go) for this.
