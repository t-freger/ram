...
- Android: Invitation link from [web](https://play.google.com/store/apps/details?id=app.alextran.ram) or from [mobile](https://play.google.com/store/apps/details?id=app.alextran.ram)
