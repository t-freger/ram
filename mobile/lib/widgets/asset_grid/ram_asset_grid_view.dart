...
import 'package:ram_mobile/providers/asset_viewer/scroll_notifier.provider.dart';
import 'package:ram_mobile/widgets/asset_grid/asset_drag_region.dart';
import 'package:ram_mobile/widgets/asset_grid/thumbnail_image.dart';
...
import 'package:ram_mobile/providers/asset_viewer/scroll_to_date_notifier.provider.dart';
...
typedef ramAssetGridSelectionListener = void Function(
  bool,
  Set<Asset>,
);

class ramAssetGridView extends ConsumerStatefulWidget {
  final RenderList renderList;
  final int assetsPerRow;
  final double margin;
  final bool showStorageIndicator;
  final ramAssetGridSelectionListener? listener;
  ...
  @override
  createState() {
    return ramAssetGridViewState();
  }
}

class ramAssetGridViewState extends ConsumerState<ramAssetGridView> {
  ...
  @override
  void didUpdateWidget(ramAssetGridView oldWidget) {
