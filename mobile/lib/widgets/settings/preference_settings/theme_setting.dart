...
import 'package:ram_mobile/widgets/settings/settings_sub_title.dart';
...
class ThemeSetting extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentTheme = useValueNotifier(ref.read(ramThemeProvider));
    ...
    void onThemeChange(bool isDark) {
      if (isDark) {
        ref.watch(ramThemeProvider.notifier).state = ThemeMode.dark;
        currentThemeString.value = "dark";
      } else {
        ref.watch(ramThemeProvider.notifier).state = ThemeMode.light;
    ...
    void onSystemThemeChange(bool isSystem) {
      if (isSystem) {
        ...
        ref.watch(ramThemeProvider.notifier).state = ThemeMode.system;
      } else {
