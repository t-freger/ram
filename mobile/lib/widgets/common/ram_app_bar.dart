...
import 'package:ram_mobile/providers/ram_logo_provider.dart';
import 'package:ram_mobile/widgets/common/app_bar_dialog/app_bar_dialog.dart';
...
import 'package:ram_mobile/models/server_info/server_info.model.dart';
...
class ramAppBar extends ConsumerWidget implements PreferredSizeWidget {
  @override
  Size get preferredSize => const Size.fromHeight(kToolbarHeight);
  final Widget? action;

  const ramAppBar({super.key, this.action});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ramLogo = ref.watch(ramLogoProvider);
    ...
    buildProfileIndicator() {
      return InkWell(
        onTap: () => showDialog(
          ...
          builder: (ctx) => const ramAppBarDialog(),
        ),
                ...
                builder: (context) {
                  ...
                  return Padding(
                    ...
                    child: SvgPicture.asset(
                      context.isDarkTheme
                          ? 'assets/ram-logo-inline-dark.svg'
                          : 'assets/ram-logo-inline-light.svg',
                      height: 40,
                    ),
                  );
                },
