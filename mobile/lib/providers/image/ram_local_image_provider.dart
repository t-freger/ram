...
class ramLocalImageProvider extends ImageProvider<ramLocalImageProvider> {
  final Asset asset;

  ramLocalImageProvider({
    required this.asset,
  ...
  @override
  Future<ramLocalImageProvider> obtainKey(ImageConfiguration configuration) {
    return SynchronousFuture(this);
  }

  @override
  ImageStreamCompleter loadImage(
    ramLocalImageProvider key,
  ...
  bool operator ==(Object other) {
    ...
    if (other is ramLocalImageProvider) {
