...
/// Only viable
class ramLocalThumbnailProvider
    extends ImageProvider<ramLocalThumbnailProvider> {
  final Asset asset;
  final int height;
  final int width;

  ramLocalThumbnailProvider({
    required this.asset,
    this.height = 256,
    this.width = 256,
  ...
  @override
  Future<ramLocalThumbnailProvider> obtainKey(
  ...
  bool operator ==(Object other) {
    if (other is! ramLocalThumbnailProvider) return false;
