...
/// [ramLogger] is a custom logger that is built on top of the [logging] package.
...
class ramLogger {
  ...
  Future<void> shareLogs() async {
    ...
    final filePath = '${tempDir.path}/ram_log_$dateTime.log';
