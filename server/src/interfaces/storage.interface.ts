...
export interface ramReadStream {
  stream: Readable;
  type?: string;
  length?: number;
}

export interface ramZipStream extends ramReadStream {
...
export interface IStorageRepository {
  ...
  createReadStream(filepath: string, mimeType?: string | null): Promise<ramReadStream>;
